        ...
        <div>
          <ul className="flex justify-center space-x-6 ">
            ...
            <li>
              <img
                className="w-8"
                src="src/assets/social/icons8-linkedin-50.png"
                alt=""
              />
            </li>
            <li>
              <img
                className="w-8"
                src="src/assets/social/icons8-snapchat-50.png"
                alt=""
              />
            </li>
            <li>
              <img
                className="w-8"
                src="src/assets/social/icons8-twitterx-50.png"
                alt=""
              />
            </li>
            <li>
              <img className="w-8" src="src/assets/social/insta.png" alt="" />
            </li>
          </ul>
        </div>
      </div>
